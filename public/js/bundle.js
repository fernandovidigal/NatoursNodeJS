...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends the map bounds to include the current location
...
var stripe = Stripe('pk_test_6FYVLPiP1mtqQxuTRT2ErZOc00jR6Iv8nA');
